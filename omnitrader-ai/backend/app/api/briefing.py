...
async def _build_report(db: AsyncSession) -> dict:
    ...
    import asyncio
    stock_info, news_map, alerts_map, macro, sector_ranks_map = await asyncio.gather(
    ...
    for a in analyses:
        ...
        card = _build_stock_card(a, stock_info, news, alert, s_rank)
